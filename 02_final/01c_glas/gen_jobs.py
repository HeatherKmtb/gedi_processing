...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def gen_command_info(self, **kwargs):
        ...
        for gedi_file in gedi_files:
            ...
            if (not os.path.exists(out_csv_file)):
                ...
                c_dict['out_fig_dir'] = '/bigdata/heather_gedi/results/glas/figs/'
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            gedi_tiles='/bigdata/heather_gedi/glas/data/2-split_per_eco/*.gpkg',
            out_fig_dir='/bigdata/heather_gedi/results/glas/figs/',
            out_csv_dir='/bigdata/heather_gedi/results/glas/csvs/')
