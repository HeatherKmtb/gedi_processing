...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            gedi_tiles='/bigdata/heather_gedi/data/1_deg_q/6.remove_slope/GEDI02_B_2020_Q1/*.gpkg',
            out_dir='/bigdata/heather_gedi/data/1_deg_q/7.merged_layers/GEDI02_B_2020_Q1')
