...
class GenCmds(PBPTGenQProcessToolCmds):
    ...
    def run_gen_commands(self):
        self.gen_command_info(
            gedi_tiles='/bigdata/heather_gedi/data/5.gedi_base_tiles/GEDI02_B_2019_Q4/*.gpkg',
            out_dir='/bigdata/heather_gedi/data/1_deg_q/1.filter_for_quality/GEDI02_B_2019_Q4')
